        ...
        ? [
              {
                  ...
                  children: groupAndTeam.map((group, index) => ({
                      ...
                      children: group.teamList ? createTeamListStructure(group.teamList) : [],
                  })),
              },
                        ...
                        <div className="group_info_wrap">
                            {showAdminButtons && (
                                <div className="admin_btn">
                                    <button
                                        type="button"
                                        onClick={groupInsertClick}
                                    >
                                        그룹추가
                                    </button>
                                    <button
                                        type="button"
                                        onClick={groupModifyClick}
                                    >
                                        그룹수정
                                    </button>
                                    <button
