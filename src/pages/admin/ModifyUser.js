...
function ModifyUser() {
  ...
  useEffect(() => {
    const hasAdminRole = userDetail.userRole?.some(
  ...
  const onClickModifyUserHandler = async () => {
    ...
    const selectedTeam = teams.find(
      (team) => team.teamCode.toString() === form.team
    );

    const userRoles = isAdmin
      ? [{ authority: { authName: "ROLE_ADMIN" } }]
      : [];
  ...
  return (
    <div id="wrap">
        ...
        <article>
          ...
          <ul className="sub_list">
            <li onClick={onClickUserRegisterHandler}>
              <div>
                <img src="/mypage/regist_user.png" alt="" />
                <span>직원 등록</span>
              </div>
            </li>
            <li className="sub_list_text" onClick={onClickUserListHandler}>
              <div>
                <img src="/mypage/user_list.png" alt="" />
                <span>전직원 목록</span>
              </div>
            </li>
          </ul>
      ...
      <main className="mainArea" style={{ background: "white" }}>
              ...
              <div className="regist_user_wrap">
                ...
                >
                  ...
                  <div className="regist_user">
                    ...
                    <div
                      className="regist_user_id"
                      name="dayoff"
                      value={
                        Number(form.dayoff?.offCount) -
                        Number(form.dayoff?.offUsed)
                      }
                      onChange={onChangeHandler}
                    >
                      {Number(form.dayoff?.offCount) -
