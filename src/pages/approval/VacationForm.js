...
function VacationForm(){
  ...
  if (approvalDetail && Array.isArray(approvalDetail?.document?.draftDay)) {
    ...
    const formattedDate2 = approvalDetail.offStart.map(num => String(num).padStart(2, '0'));
    const formattedDate3 = approvalDetail.offEnd.map(num => String(num).padStart(2, '0'));
        ...
        <table>
          ...
          <tbody className="tbtb">
            ...
            <tr>
              ...
              <td className="inputsize">
                <input type="text" className="inputtext1" value={(approvalDetail?.document?.userDTO?.dayoff?.offCount) - (approvalDetail?.document?.userDTO?.dayoff?.offUsed)}/>
              </td>
            </tr>
          </tbody>
        </table>
            ...
            <tr>
              ...
              <td className="hihi">
                <input
                  ...
                  name='offReason'
                value={approvalDetail?.offReason}
