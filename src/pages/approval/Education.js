  ...
  useEffect(() => {
    ...
    const onFileChange = (e) => {
      ...
      const onClickInsertDocumentHandler = () => {
        ...
        formData.append("eduTitle", form.eduTitle);
      formData.append("eduName", form.eduName);
      formData.append("eduStart", form.eduStart);
      formData.append("eduFinish", form.eduFinish);
      formData.append("eduInstitution", form.eduInstitution);
      formData.append("eduPrice", form.eduPrice);
      formData.append("eduContent", form.eduContent);
      ...
      formData.append("file", form.file);
        ...
        if(form.eduTitle === '' 
              || form.lineUser === ''|| form.eduStart === ''|| form.eduFinish === ''|| form.eduInstitution === ''|| form.eduPrice === ''|| form.eduContent === ''|| form.eduName === ''){
                  alert('공란을 입력해주세요.');
                  return ;
          }
        
  
      dispatch(callInsertEducationAPI({	
        form: formData
        ...
        <table>
          ...
          <tbody className="tbtb">
            ...
            <tr>
              ...
              <td className="inputsize">
                <input type="text" className="inputtext1" value={getDaysDifference(form.eduStart,form.eduFinish)+ 1} />
              </td>
            </tr>
          </tbody>
        </table>
